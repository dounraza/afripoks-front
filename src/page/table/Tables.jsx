...
const Tables = () => {
    ...
    // On stocke l'id dans sessionStorage dès qu'il clique sur "Jouer"
    // Au retour, on lit cet id pour afficher le bouton "Rejoindre"
    ...
    const goToTable = (tableId, caveValue) => {
        sessionStorage.setItem('lastTableId', String(tableId)); // ← mémorisation
                                ...
                                <div className="rejoin-banner">
                                    <div className="rejoin-banner-left">
                                        ...
                                        <div className="rejoin-meta">
                                            ...
                                            <span><Wallet size={13} /> SB {(lastTable?.smallBlind ?? 0).toLocaleString()} / BB {(lastTable?.bigBlind ?? 0).toLocaleString()} Ar</span>
                                        </div>
                                    </div>
                                    ...
                                    <div key={i} className="lobby-card">
                                        <div className="lobby-card-image">
                                            <img
                                                ...
                                                alt="Poker cards"
                                                onError={(e) => { e.target.src = pokerBackground; }}
                                            />
